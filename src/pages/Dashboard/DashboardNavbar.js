...
const DashboardNavbar = () => {
	...
	return (
		...
		<div className="navbar-start">
			...
			<Link to='/dashboard' className="btn btn-ghost normal-case text-xl hidden lg:flex shadow-md rounded-lg mr-2">To Do App</Link>
		</div>
		...
		<Link to='/dashboard' className="btn btn-ghost normal-case text-xl lg:hidden shadow-md rounded-lg mr-2">To Do App</Link>
		</div>
		</div>
	);
};
